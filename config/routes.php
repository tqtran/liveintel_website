...
return [
    ...
    $route('/about.php', 'About | LiveIntel', 'monthly', '0.6', 'about.php'),
    $route('/contact.php', 'Contact | LiveIntel', 'monthly', '0.6', 'contact.php'),
    $route('/legal/security.php', 'Security | LiveIntel', 'monthly', '0.5', 'legal/security.php'),
    $route('/legal/privacy-policy.php', 'Privacy Policy | LiveIntel', 'yearly', '0.3', 'legal/privacy-policy.php'),
    $route('/legal/terms-of-service.php', 'Terms of Service | LiveIntel', 'yearly', '0.3', 'legal/terms-of-service.php'),
